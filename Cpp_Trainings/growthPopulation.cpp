...
aug is an integer (> 0), percent a positive or null floating number,
...
int main() {
	...
	cout << "Years: " << arge.nbYear(1500, 5, 100, 5000) << endl;
	cout << "Years: " << arge.nbYear(1500000, 2.5, 10000, 2000000) << endl;
	cout << "Years: " << arge.nbYear(1500000, 0.25, 1000, 2000000) << endl;
	cout << "Years: " << arge.nbYear(1500000, 0.25, -1000, 2000000) << endl;
